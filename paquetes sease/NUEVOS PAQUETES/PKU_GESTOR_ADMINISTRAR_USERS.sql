...
PROCEDURE f_lista_perfiles_cambiado;
  ...
  function f_get_ubigeo_ue2(  v_dep_codigo_vb          varchar2,
                              v_pro_codigo_vb          varchar2,
                              v_dis_codigo_vb          varchar2 )
        return varchar2;
   ...
   BEGIN
    ...
    <script>
        ...
        function abrir( pID, sDO, param, nventana)
            {  
            newWindow = window.open("ControllerServletOpen?portletid="+pID+"&scriptdo="+sDO+param,nventana,"toolbar=no,Width=700,Height=400,scrollbars=yes,modal=yes,dependent,alwaysRaised")
   ...
   usp_print('<INPUT name="tipo_ubi" type="hidden"/> ');
    ...
    <br>
        ...
        <tr class="active">
            ...
            <td  style="width:40%">Seleccione la entidad.</td>
        </tr>
        <tr class="active">
        ...
        <div>
            <h3>Ubicaci&oacute;n Geogr&aacute;fica de &oacute;rgano Desconcentrado o Unidad Operativa</h3>
        </div>
        <table class="table table-bordered">');
    usp_print (f_get_ubigeo_ue2(null,null,null));
    ...
    usp_print
        ...
        <tr class="active">
            ...
            <td style="width:40%">Ingrese el nombre del solicitante.</td>
        </tr>
        <tr  class="active">
        ...
        <div>
            <h3>Datos del Funcionario - Usuario</h3>
        </div>
        <table class="table table-bordered">
        <tr class="active">
...
*/
   ...
   BEGIN
    ...
    <table class="table table-bordered">
        <tr>
            <td style="width:30%">C&oacute;digo</td>
            <td style="width:35%">
                <input type="text" name="ag_grupcod" maxlength="30" style="width:98%"/></td>
            <td style="width:35%">Ingrese el c&oacute;digo del grupo.</td>
        </tr>
        <tr>
            <td style="width:30%">Nombre</td>
            <td class=c2>
        ...
        <tr>
            ...
            <td class=c2>
                <textarea name="ag_grupcoment" rows="8" columns = "180" class="form-control" style="width:250px"></textarea>
      ...
      LOOP
        ...
        <tr>
            ...
            || CASE
                ...
                ELSE  '<input type="text" name="ag_grupcod" maxlength="30" class="form-control" value="'|| r_grupo.usu_codigo|| '"/>'  END ||'</td>
            <td style="width:35%">C&oacute;digo del grupo.</td>
        </tr>
        <tr>
            <td class=c1>Nombre</td>
            <td class=c2>
                <input type="text" name="ag_grupnom" maxlength="100"  value="'
             || r_grupo.usu_nombre
             || '"/></td>
        ...
        <tr>
            <td class=c1>Descripci&oacute;n</td>
            <td class=c2>
                <textarea name="ag_grupcoment" class="form-control" rows="8" columns="180" style="width:98%" >'
             || r_grupo.usu_coment
             || '</textarea></td>
            <td class=c3>Descripci&oacute;n del grupo.</td>
        </tr>
...
--cambios arbitro nueva ley  
   ...
   begin
     ...
     <td style="width:30%">Ubicaci&oacute;n Geografica</td>
     <td style="width:30%">
        <INPUT name="v_dep_codigo_vb" readonly="true" value="'||v_dep_codigo_vb||'" type="hidden"/>
        <INPUT name="v_pro_codigo_vb" readonly="true" value="'||v_pro_codigo_vb||'" type="hidden"/>
        <INPUT name="v_dis_codigo_vb" readonly="true" value="'||v_dis_codigo_vb||'" type="hidden"/>
        <INPUT name="lugar_ejec_vb" class="ViewSelect form-control" onclick="BuscaUbigeo(2)"  readonly  value="'||i_dep_desc||'/'||i_pro_desc||'/'||i_dis_desc||'"/>
    </td>
    <td style="width:40%">Seleccione la ubicaci&oacute;n geogr&aacute;fica.</td>
    </tr>';
...
order by n_id_tipo_maestro;
   ...
   <div style="text-align: right">
        <input type="button" value="Crear Usuario" onclick="enviar()"/>
   </div>
  <br/>
  <table class="table table-bordered">
       <tr class="active">
